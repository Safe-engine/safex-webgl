...
import { arrayRemoveObject, BATCH_VERTEX_COUNT, VERTEX_ATTRIB_COLOR, VERTEX_ATTRIB_POSITION, VERTEX_ATTRIB_TEX_COORDS } from "../platform/Macro";
...
export const rendererWebGL = (function () {
  ...
  return {
    ...
    rendering: function (ctx: WebGLRenderingContext, cmds?: any[]) {
      ...
      let i, len, cmd
      let context = ctx || _renderContext;
