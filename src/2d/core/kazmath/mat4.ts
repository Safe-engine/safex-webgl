 ...
 * @returns {Matrix4}
 */
Matrix4.createByRotationX = function (radians, matrix) {
  //kmMat4RotationX
  /*
   |  1  0       0       0 |
   M = |  0  cos(A) -sin(A)  0 |
 ...
 * @returns {*}
 */
Matrix4.createByRotationY = function (radians, matrix) {
  // kmMat4RotationY
  /*
   |  cos(A)  0   sin(A)  0 |
   M = |  0       1   0       0 |
 ...
 * @return {Matrix4}
 */
Matrix4.createByRotationZ = function (radians, matrix) {
  // kmMat4RotationZ
  /*
   |  cos(A)  -sin(A)   0   0 |
   M = |  sin(A)   cos(A)   0   0 |
 ...
 * @returns {Matrix4}
 */
Matrix4.createByScale = function (x, y, z, matrix) {
  //kmMat4Scaling
  matrix = matrix || new Matrix4()
  const mat = matrix.mat
  mat[0] = x
