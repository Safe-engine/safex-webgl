...
proto.getUpVec3 = function () {
  var mat = this.mat;
  var ret = new Vec3(mat[4], mat[5], mat[6]);
...
proto.getRightVec3 = function () {
  var mat = this.mat;
  var ret = new Vec3(mat[0], mat[1], mat[2]);
  return ret.normalize();
};
...
proto.getForwardVec3 = function () {
  var mat = this.mat;
  var ret = new Vec3(mat[8], mat[9], mat[10]);
  return ret.normalize();
};
...
export const kmMat4LookAt = function (pOut, pEye, pCenter, pUp) {
  var f = new Vec3(pCenter), up = new Vec3(pUp);
  f.subtract(pEye);
  f.normalize();
  up.normalize();
...
proto.lookAt = function (eyeVec, centerVec, upVec) {
  var f = new Vec3(centerVec), up = new Vec3(upVec), mat = this.mat;
  f.subtract(eyeVec);
  f.normalize();
  up.normalize();
...
export const kmMat4RotationAxisAngle = function (pOut, axis, radians) {
  ...
  var normalizedAxis = new Vec3(axis);
...
proto.extractRotation = function () {
  var matrix = new Matrix3(), mat4 = this.mat, mat3 = matrix.mat;
  mat3[0] = mat4[0];
  mat3[1] = mat4[1];
  mat3[2] = mat4[2];
...
proto.extractPlane = function (planeType) {
  var plane = new Plane(), mat = this.mat;
  switch (planeType) {
    case Plane.RIGHT:
      plane.a = mat[3] - mat[0];
      plane.b = mat[7] - mat[4];
