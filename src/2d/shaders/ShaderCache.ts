...
import { ATTRIBUTE_NAME_COLOR, ATTRIBUTE_NAME_POSITION, ATTRIBUTE_NAME_TEX_COORD, SHADER_POSITION_COLOR, SHADER_POSITION_LENGTHTEXTURECOLOR, SHADER_POSITION_TEXTURE, SHADER_POSITION_TEXTURE_UCOLOR, SHADER_POSITION_TEXTUREA8COLOR, SHADER_POSITION_TEXTURECOLOR, SHADER_POSITION_TEXTURECOLORALPHATEST, SHADER_POSITION_UCOLOR, SHADER_SPRITE_POSITION_COLOR, SHADER_SPRITE_POSITION_TEXTURECOLOR, SHADER_SPRITE_POSITION_TEXTURECOLOR_GRAY, SHADER_SPRITE_POSITION_TEXTURECOLORALPHATEST, VERTEX_ATTRIB_COLOR, VERTEX_ATTRIB_POSITION, VERTEX_ATTRIB_TEX_COORDS } from "../core/platform/Macro";
import { GLProgram } from "./GLProgram";
import { SHADER_POSITION_COLOR_FRAG, SHADER_POSITION_COLOR_LENGTH_TEXTURE_FRAG, SHADER_POSITION_COLOR_LENGTH_TEXTURE_VERT, SHADER_POSITION_COLOR_VERT, SHADER_POSITION_TEXTURE_A8COLOR_FRAG, SHADER_POSITION_TEXTURE_A8COLOR_VERT, SHADER_POSITION_TEXTURE_COLOR_ALPHATEST_FRAG, SHADER_POSITION_TEXTURE_COLOR_FRAG, SHADER_POSITION_TEXTURE_COLOR_VERT, SHADER_POSITION_TEXTURE_FRAG, SHADER_POSITION_TEXTURE_UCOLOR_FRAG, SHADER_POSITION_TEXTURE_UCOLOR_VERT, SHADER_POSITION_TEXTURE_VERT, SHADER_POSITION_UCOLOR_FRAG, SHADER_POSITION_UCOLOR_VERT, SHADER_SPRITE_POSITION_COLOR_VERT, SHADER_SPRITE_POSITION_TEXTURE_COLOR_GRAY_FRAG, SHADER_SPRITE_POSITION_TEXTURE_COLOR_VERT } from "./Shaders";
...
export const shaderCache = /** @lends shaderCache# */{
    ...
    reloadDefaultShaders: function () {
        ...
        var program = this.programForKey(SHADER_POSITION_TEXTURECOLOR);
        program.reset();
