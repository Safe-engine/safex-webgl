...
export const ProgressTimerWebGLRenderCmd = function (renderableObject) {
...
const proto = (ProgressTimerWebGLRenderCmd.prototype = Object.create(NodeWebGLRenderCmd.prototype))
proto.constructor = ProgressTimerWebGLRenderCmd
