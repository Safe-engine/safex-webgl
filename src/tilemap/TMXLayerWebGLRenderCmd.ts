...
export const TMXLayerWebGLRenderCmd = function (renderableObject) {
...
const proto = (TMXLayerWebGLRenderCmd.prototype = Object.create(NodeWebGLRenderCmd.prototype))
proto.constructor = TMXLayerWebGLRenderCmd
