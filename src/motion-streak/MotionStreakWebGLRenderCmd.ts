...
import { SpriteWebGLRenderCmd } from '../core/sprites/SpriteWebGLRenderCmd'
import { glBindTexture2D, glBlendFunc } from '../shaders/GLStateCache'
import { shaderCache } from '../shaders/ShaderCache'

export const MotionStreakWebGLRenderCmd = function (renderableObject) {
...
MotionStreakWebGLRenderCmd.prototype = Object.create(NodeWebGLRenderCmd.prototype)
MotionStreakWebGLRenderCmd.prototype.constructor = SpriteWebGLRenderCmd

MotionStreakWebGLRenderCmd.prototype.rendering = function (ctx) {
