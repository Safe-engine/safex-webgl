 ...
 */
RotateTo = ActionInterval.extend(
  /** @lends RotateTo# */ {
    _dstAngleX: 0,
    _startAngleX: 0,
    _diffAngleX: 0,
 ...
 */
rotateTo = function (duration, deltaAngleX, deltaAngleY) {
  return new RotateTo(duration, deltaAngleX, deltaAngleY)
}

/**
 * Please use rotateTo instead
 * Creates a RotateTo action with separate rotation angles.
 * To specify the angle of rotation.
 * @static
 * @deprecated since v3.0 <br /> Please use rotateTo instead.
 * @param {Number} duration duration in seconds
 * @param {Number} deltaAngleX deltaAngleX in degrees.
 * @param {Number} [deltaAngleY] deltaAngleY in degrees.
 * @return {RotateTo}
 */
RotateTo.create = rotateTo
 ...
 */
RotateBy = ActionInterval.extend(
  /** @lends RotateBy# */ {
    _angleX: 0,
    _startAngleX: 0,
    _angleY: 0,
 ...
 */
rotateBy = function (duration, deltaAngleX, deltaAngleY) {
  return new RotateBy(duration, deltaAngleX, deltaAngleY)
}
/**
 * Please use rotateBy instead.
 * Rotates a Node object clockwise a number of degrees by modifying it's rotation attribute.
 * Relative to its properties to modify.
 * @static
 * @deprecated since v3.0 <br /> Please use rotateBy instead.
 * @param {Number} duration duration in seconds
 * @param {Number} deltaAngleX deltaAngleX in degrees
 * @param {Number} [deltaAngleY] deltaAngleY in degrees
 * @return {RotateBy}
 */
RotateBy.create = rotateBy
