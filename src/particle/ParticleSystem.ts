 ...
 *     - texture                    <br/>
 *                                  <br/>
 *     safex also supports particles generated by Particle Designer (http://particledesigner.71squared.com/).<br/>
 *     'Radius Mode' in Particle Designer uses a fixed emit rate of 30 hz. Since that can't be guarateed in safex,  <br/>
 *     safex uses a another approach, but the results are almost identical.<br/>
 *     safex supports all the variables used by Particle Designer plus a bit more:  <br/>
