 ...
 */
export const Widget = ProtectedNode.extend(/** @lends Widget# */{
     ...
     */
    ctor: function () {
        ProtectedNode.prototype.ctor.call(this);
    ...
    onEnter: function () {
        ...
        if (this._sizeDirty)
            this._onSizeChanged();
        ProtectedNode.prototype.onEnter.call(this);
    },
    ...
    onExit: function () {
        ...
        ProtectedNode.prototype.onExit.call(this);
    },
     ...
     */
    hitTest: function (pt) {
        var bb = rect(0, 0, this._contentSize.width, this._contentSize.height);
    ...
    _createRenderCmd: function () {
        if (_renderType === game.RENDER_TYPE_WEBGL)
            return new Widget.WebGLRenderCmd(this);
        else
...
/** @expose */
_p.xPercent;
defineGetterSetter(_p, "xPercent", _p._getXPercent, _p._setXPercent);
/** @expose */
_p.yPercent;
defineGetterSetter(_p, "yPercent", _p._getYPercent, _p._setYPercent);
/** @expose */
_p.widthPercent;
defineGetterSetter(_p, "widthPercent", _p._getWidthPercent, _p._setWidthPercent);
/** @expose */
_p.heightPercent;
defineGetterSetter(_p, "heightPercent", _p._getHeightPercent, _p._setHeightPercent);
/** @expose */
_p.widgetParent;
defineGetterSetter(_p, "widgetParent", _p.getWidgetParent);
/** @expose */
_p.enabled;
defineGetterSetter(_p, "enabled", _p.isEnabled, _p.setEnabled);
/** @expose */
_p.focused;
defineGetterSetter(_p, "focused", _p.isFocused, _p.setFocused);
/** @expose */
_p.sizeType;
defineGetterSetter(_p, "sizeType", _p.getSizeType, _p.setSizeType);
/** @expose */
_p.widgetType;
defineGetterSetter(_p, "widgetType", _p.getWidgetType);
/** @expose */
_p.touchEnabled;
defineGetterSetter(_p, "touchEnabled", _p.isTouchEnabled, _p.setTouchEnabled);
/** @expose */
_p.updateEnabled;
defineGetterSetter(_p, "updateEnabled", _p.isUpdateEnabled, _p.setUpdateEnabled);
/** @expose */
_p.bright;
defineGetterSetter(_p, "bright", _p.isBright, _p.setBright);
/** @expose */
_p.name;
defineGetterSetter(_p, "name", _p.getName, _p.setName);
/** @expose */
_p.actionTag;
defineGetterSetter(_p, "actionTag", _p.getActionTag, _p.setActionTag);
/** @expose */
_p.opacity;
...
Widget._focusedWidget = null;                        //both layout & widget will be stored in this variable
...
Widget.enableDpadNavigation = function (enable) {
    if (enable) {
        if (null == Widget._focusNavigationController) {
            Widget._focusNavigationController = new _FocusNavigationController();
