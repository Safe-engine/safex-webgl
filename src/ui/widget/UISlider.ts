 ...
 */
export const Slider = ccui.Widget.extend(/** @lends ccui.Slider# */{
  _barRenderer: null,
  ...
  setPercent: function (percent) {
    ...
    if (this._scale9Enabled)
      this._progressBarRenderer.setPreferredSize(size(dis, this._contentSize.height));
    else {
  ...
  hitTest: function (pt) {
    ...
    var ballRect = rect(0, 0, ballSize.width, ballSize.height);
...
/** @expose */
_p.percent;
defineGetterSetter(_p, "percent", _p.getPercent, _p.setPercent);
