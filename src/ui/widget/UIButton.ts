...
export class Button extends Widget { 
  ...
  _normalFileName: string = ''
  _clickedFileName: string = ''
  _disabledFileName: string = ''
  ...
  pressedActionEnabled: boolean = false
  _titleColor: any = null

  _zoomScale: number = 0.1

  _normalTextureLoaded: boolean = false
  _pressedTextureLoaded: boolean = false
  _disabledTextureLoaded: boolean = false

  _className: string = 'Button'
  _normalTextureAdaptDirty: boolean = true

  _fontName: string = 'Thonburi'
  _fontSize: number = 12
  _type: number = 0
  ...
  _createSpriteFrameWithFile (file) {
      ...
      const rect = rect(0, 0, textureSize.width, textureSize.height)
